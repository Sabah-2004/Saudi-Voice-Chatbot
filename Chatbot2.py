...
class VoiceChatbot:
    def __init__(self):
        self.cohere = cohere.Client("xchjEmqHQPx3hYEYkMjWwaKOgQQKc21PAOub4QdF")  # Replace with your actual Cohere API key
        self.elevenlabs = ElevenLabs(api_key="sk_de971446b3049524f934fd93e3d2f00ca1dff8fd1b734e02")  # Replace with your actual ElevenLabs API key
    ...
    def think(self, text):
        response = self.cohere.chat(model="command-r7b-arabic-02-2025",message=text,temperature=0.7,max_tokens=200, preamble="جاوب بلهجة سعودية فقط، جاوب بشكل مختصر، اسمك هو المساعد الذكي وقد صممك صباح سامي فتيحي")
